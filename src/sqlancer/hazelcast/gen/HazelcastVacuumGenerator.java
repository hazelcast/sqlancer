...
public final class HazelcastVacuumGenerator {

    private HazelcastVacuumGenerator() {
    }
    ...
    private static void addTableAndColumns(HazelcastTable table, StringBuilder sb) {
        sb.append(" ");
        sb.append(table.getName());
        if (Randomly.getBoolean()) {
            sb.append("(");
