...
public final class HazelcastDropIndexGenerator {

    private HazelcastDropIndexGenerator() {
    }

    public static SQLQueryAdapter create(HazelcastGlobalState globalState) {
        List<HazelcastIndex> indexes = globalState.getSchema().getRandomTable().getIndexes();
