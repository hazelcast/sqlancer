...
public final class HazelcastSequenceGenerator {

    private HazelcastSequenceGenerator() {
    }

    public static SQLQueryAdapter createSequence(HazelcastGlobalState globalState) {
