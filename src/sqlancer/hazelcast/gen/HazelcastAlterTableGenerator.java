...
public class HazelcastAlterTableGenerator {

    private HazelcastTable randomTable;
    private Randomly r;
    private static HazelcastColumn randomColumn;
    ...
    public HazelcastAlterTableGenerator(HazelcastTable randomTable, HazelcastGlobalState globalState,
    ...
    public static SQLQueryAdapter create(HazelcastTable randomTable, HazelcastGlobalState globalState,
                                         boolean generateOnlyKnown) {
        return new HazelcastAlterTableGenerator(randomTable, globalState, generateOnlyKnown).generate();
    }
    ...
    public SQLQueryAdapter generate() {
        ...
        for (Action a : action) {
            ...
            case ALTER_COLUMN_TYPE:
                ...
                sb.append(" TYPE ");
                HazelcastDataType randomType = HazelcastDataType.getRandomType();
                HazelcastCommon.appendDataType(randomType, sb, false, generateOnlyKnown, opClasses);
            ...
            case ALTER_COLUMN_SET_DROP_DEFAULT:
                ...
                if (Randomly.getBoolean()) {
                    ...
                    sb.append(HazelcastVisitor.asString(
                            HazelcastExpressionGenerator.generateExpression(globalState, randomColumn.getType())));
            ...
            case ADD_TABLE_CONSTRAINT:
                ...
                HazelcastCommon.addTableConstraint(sb, randomTable, globalState, errors);
    ...
    private static void alterColumn(HazelcastTable randomTable, StringBuilder sb) {
        sb.append("ALTER ");
