...
public final class HazelcastViewGenerator {

    private HazelcastViewGenerator() {
    }
    ...
    public static SQLQueryAdapter create(HazelcastGlobalState globalState) {
        ...
        // }
        sb.append(" AS (");
        HazelcastSelect select = HazelcastRandomQueryGenerator.createRandomQuery(nrColumns, globalState);
        sb.append(HazelcastVisitor.asString(select));
        sb.append(")");
