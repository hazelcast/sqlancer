...
public final class HazelcastNotifyGenerator {

    private HazelcastNotifyGenerator() {
    }
    ...
    public static SQLQueryAdapter createNotify(HazelcastGlobalState globalState) {
